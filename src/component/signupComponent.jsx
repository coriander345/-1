...
const SignupComponent = () => {
	...
	const doubleCheckPassWord = () => {
		...
		else if (password !== pwCheck) setMessagePwCheck('비밀번호를 다시 확인해주세요!')
		else if (password === pwCheck) setMessagePwCheck('✔ 비밀번호가 확인되었습니다!')
	};
  ...
  return (
    <Wrapper>
      <TitleArea>
        ...
        <MainText> 회원가입 후 맛과 간편성 모두 잡은 레시피들을 확인해보세요 </MainText>
      </TitleArea>
      <Form>
        <FormGroup>
          <Labal>이메일
